...
//            new EaseAlertDialog(this, "demo中只有" + sb.toString() + "这几个账户才能开启直播").show();
    ...
    private void createLive() {
        final User user = EaseUserUtils.getAppUserInfo(EMClient.getInstance().getCurrentUser());
        if (user != null) {
            NetDao.createLive(StartLiveActivity.this, user, new OnCompleteListener<String>() {
                ...
                public void onSuccess(String s) {
                    ...
                    if (s != null) {
                        ...
                        L.e("StartLive","id1====="+id);
                        if (id != null ) {
                            L.e("StartLive","id2======"+id);
                            success = true;
                            initLive(id);
                           // startLiveByChatRoom();
    ...
    private void showConfirmCloseLayout() {
        ...
        for (LiveRoom liveRoom : liveRoomList) {
            if (liveRoom.getId().equals(liveId)) {
                EaseUserUtils.setAppUserAvatar(this,liveRoom.getCover(),coverImage);
